  ...
  return (
    <>
      ...
      <div className="flex gap-31 pt-15 pb-35">
        ...
        <div className="pb-10 ">
          <h1 className="pb-6 text-3xl">Create an account</h1>
...
<div className="flex flex-col">
          ...
          <input
            type="text"
            placeholder="Name"
            class="border-b border-gray-300 w-90 focus:border-black outline-none bg-transparent pb-1  transition-colors "
            />
          <input
            type="text"
          ...
          <input
            ...
            <div className=' pt-13'>
      <button className='bg-[#DB4444] flex px-32 py-4 rounded-sm '>Create Account</button>
    </div>
            <div className=' pt-13'>
      <button className='border flex px-[98px] py-2 rounded-sm gap-4 '>  <img src="Google.png" alt="" /> View All Products</button>
    </div>
 <div className="flex gap-3 pt-8">
            <h1>Already have account?</h1>
            <h2 className="hover:underline cursor-pointer">      <Link href="/Login">Log in</Link>
</h2>
        </div>
        </div>
